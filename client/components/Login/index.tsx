...
const Login = ({ serverUsers }) => {
	...
	const [registrationData, setRegistrationData] = useState({ name: '', surname: '', password: '', image: null });
			...
			<div className={styles.login}>
				<div className='container-fluid'>
					<div className='row'>
						...
						{registration && (
							<Swiper navigation pagination={{ type: 'fraction' }} style={{ height: 400, marginTop: 90 }}>
								<SwiperSlide>
									<label htmlFor='exampleInputEmail1' className='form-label'>
										Введите ваше имя:
									</label>
									<input type='text' value={registrationData.name} onChange={(e) => setRegistrationData((state) => ({ ...state, name: e.target.value }))} />
								</SwiperSlide>
								<SwiperSlide>
									<label htmlFor='exampleInputEmail1' className='form-label'>
										Введите фамилию:
									</label>
									<input type='text' value={registrationData.surname} onChange={(e) => setRegistrationData((state) => ({ ...state, surname: e.target.value }))} />
								</SwiperSlide>
								{/* <SwiperSlide>
						<label htmlFor='exampleInputEmail1' className='form-label'>
						...
						<input type='text' />
								...
								<SwiperSlide>
									...
									<input type='text' value={registrationData.password} onChange={(e) => setRegistrationData((state) => ({ ...state, password: e.target.value }))} />
								</SwiperSlide>
								<SwiperSlide>
									<label htmlFor='exampleInputEmail1' className='form-label'>
										Загрузите фотографию:
									</label>
									<input type='file' value={registrationData.image} onChange={(e) => setRegistrationData((state) => ({ ...state, image: e.target.value }))} />
									<PhotoCameraIcon />
								</SwiperSlide>
								<SwiperSlide>
