                  ...
                  <div className="col-md-8">
                    <div className={styles.profile__right}>
                      <div className="profile__list friendList">
                        ...
                        >
                          {profile.friends.map(
                            ({ _id, name, surname, nickname, photos }) => (
                              <SwiperSlide
                                key={_id}
                                style={{
                                  cursor: "pointer",
                              ...
                              >
                                <Link href={`/profile/${nickname}`}>
                                  <div className="friendList__slide">
                                    <div
                                      className={
                                        styles.friendList__slideProfile
                                      }
                                      style={{
                            ...
                            >
                              <Link href={`http://localhost:9000/${photo}`}>
                                <div className={styles.photoList__slide}>
                                  <div
                                    className={styles.photoList__slideImg}
                                    style={{
                                      backgroundImage: `url(http://localhost:9000/${photo})`,
                                    }}
                                  />
                                </div>
                              </Link>
                        ...
                        >
                          {profile.audios.map((audio) => (
                            ...
                            >
                              <Link
                                href={`http://localhost:9000/${audio.sound}`}
                              >
                                <div className={styles.photoList__slide}>
